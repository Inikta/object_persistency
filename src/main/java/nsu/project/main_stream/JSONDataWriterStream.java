...
public class JSONDataWriterStream<K> implements JSONDataStream<K> {
     ...
     */
    @Override
    public JSONDataWriterStream<K> sequential() {
        return null;
    }
     ...
     */
    @Override
    public JSONDataWriterStream<K> parallel() {
        return null;
    }
     ...
     */
    @Override
    public JSONDataWriterStream<K> unordered() {
        return null;
    }
     ...
     */
    @Override
    public JSONDataWriterStream<K> onClose(Runnable closeHandler) {
        return null;
    }
